...
First Name: <input type="text" name="name1" id="name1"><br><br>

Last Name: <input type="text" name="name2" id="name2"><br><br>
...
Username: <input name="username" onclick="return user_name();"><br><br>

    Password: <input type="password" name="password" id="password"><br><br>

    Confirm Password: <input type="password" name="conpass" id="conpass"><br><br>
...
Joining Date: <input type="date" name="joindate" /><br><br>
...
<?php $_SESSION["message"] = "Employee has been added"; ?>
